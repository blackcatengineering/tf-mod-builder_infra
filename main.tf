...
# Replaced by combined
# module "builder-istio-ambient" {
#   count         = (var.enable_istio_ambient) ? 1 : 0
#   source        = "git@github.com:blackcatengineering/tf-mod-istio-ambient"
#   istio_version = "1.29.0"
#   providers = {
#     helm       = helm.helm_config
#     kubernetes = kubernetes.kubernetes_config
...
module "trust-manager" {
  ...
  source = "git@github.com:blackcatengineering/tf-mod-trust-manager"
  providers = {
    helm       = helm.helm_config
    kubernetes = kubernetes.kubernetes_config
  }
